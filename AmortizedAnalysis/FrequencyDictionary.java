...
public class FrequencyDictionary {
    ...
    public static void main(String[] args) {
        ...
        text = text.toLowerCase().replace(" ", "").replace(",", "").replace(".", "").replace("!", "").replace("?", "").replace("-", "");
        System.out.println(text);
        List<Integer>  letterFrequency = new ArrayList<>();
        ...
        for (int i = 0; i < text.length(); i++){
          ...
          if(c >= 'а'&& c <= 'я'){
              int index = c - 'а';
              int currentFrequency = letterFrequency.get(index);
              letterFrequency.set(index, currentFrequency + 1);
          }
        }
        for (int i = 0; i < 32; i++) {
            char letter =(char)('а' + i);
            int frequency = letterFrequency.get(i);
            System.out.println(letter + ":" + letterFrequency.get(i));
        }
